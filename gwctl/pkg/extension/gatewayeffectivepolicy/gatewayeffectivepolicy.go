...
func (rm *Extension) calculateInheritedPolicies(graph *topology.Graph) error {
	if err := rm.calculateInheritedPoliciesForGateways(graph); err != nil {
		return err
	}
	if err := rm.calculateInheritedPoliciesForHTTPRoutes(graph); err != nil {
		return err
	}
	if err := rm.calculateInheritedPoliciesForBackends(graph); err != nil {
		return err
	}
	return nil
}
...
func (rm *Extension) calculateInheritedPoliciesForGateways(graph *topology.Graph) error {
...
func (rm *Extension) calculateInheritedPoliciesForHTTPRoutes(graph *topology.Graph) error {
...
func (rm *Extension) calculateInheritedPoliciesForBackends(graph *topology.Graph) error {
