...
func TestHTTPRouteFilter(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			wantErrors: []string{"filter.RequestHeaderModifier must be specified for RequestHeaderModifier HTTPRouteFilter.Type", "filter.RequestMirror must be nil if the HTTPRouteFilter.Type is not RequestMirror"},
		},
		{
			...
			wantErrors: []string{"filter.RequestHeaderModifier must be specified for RequestHeaderModifier HTTPRouteFilter.Type"},
		},
		{
		...
		},
		{
			...
			wantErrors: []string{"filter.RequestHeaderModifier must be nil if the HTTPRouteFilter.Type is not RequestHeaderModifier", "filter.RequestMirror must be specified for RequestMirror HTTPRouteFilter.Type"},
		},
		{
			...
			wantErrors: []string{"filter.RequestMirror must be specified for RequestMirror HTTPRouteFilter.Type"},
		},
		{
		...
		},
		{
			...
			wantErrors: []string{"filter.RequestMirror must be nil if the HTTPRouteFilter.Type is not RequestMirror", "filter.RequestRedirect must be specified for RequestRedirect HTTPRouteFilter.Type"},
		},
		{
			...
			wantErrors: []string{"filter.RequestRedirect must be specified for RequestRedirect HTTPRouteFilter.Type"},
		},
		{
		...
		},
		{
			...
			wantErrors: []string{"filter.RequestMirror must be nil if the HTTPRouteFilter.Type is not RequestMirror", "filter.ExtensionRef must be specified for ExtensionRef HTTPRouteFilter.Type"},
		},
		{
			...
			wantErrors: []string{"filter.ExtensionRef must be specified for ExtensionRef HTTPRouteFilter.Type"},
		},
		{
		...
		},
		{
			...
			wantErrors: []string{"filter.RequestMirror must be nil if the HTTPRouteFilter.Type is not RequestMirror", "filter.URLRewrite must be specified for URLRewrite HTTPRouteFilter.Type"},
		},
		{
			...
			wantErrors: []string{"filter.URLRewrite must be specified for URLRewrite HTTPRouteFilter.Type"},
		},
	}
